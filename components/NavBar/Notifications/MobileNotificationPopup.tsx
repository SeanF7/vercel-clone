...
import { Notification, CommentFilters, CommentThread } from "@/types";
...
export const MobileNotificationPopup = ({
  ...
  return createPortal(
    <>
      ...
      />
      <div
        className="mobilePopupAfter fixed bottom-0 left-0 z-20 flex h-4/5 w-full bg-black"
        ref={menuPopup}
      >
        {selectedComment ? (
          <div className="rounded-md  bg-black shadow-[0_0px_1px_1px] shadow-neutral-800">
            <div className="flex flex-col border-b border-neutral-700">
              <div className="sticky top-0 flex h-12 items-center justify-between pl-1 pr-2">
                <button
...
const MobileComments = ({
  ...
  return (
    <div
      ...
      onClick={(e) => {
        e.stopPropagation();
        setSelectedComment(commentThread);
      }}
    >
