...
export const GridProject = ({
  ...
  return (
    <div className="group flex">
      <Link
        href={`https://${url}`}
        className="flex flex-1 flex-col justify-between rounded-md bg-neutral-950 px-4 pt-6 align-middle shadow-[0_0px_0px_1px] shadow-neutral-800 transition-colors hover:bg-neutral-800"
      >
